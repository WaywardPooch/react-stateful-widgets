...
export default function Programmers() {
  ...
  const [featuredDevID, setFeaturedDevID] = useState(null);
  ...
  const getNameOfFeatured = () => {
    ...
    return programmers[featuredDevID - 1]["name"];
  };

  const style = {
    fontSize: "1.5em",
    marginTop: "0.5em",
    color: featuredDevID !== null ? "gold" : "royalblue", // 🤔 color turns to gold, when celebrating
  };
